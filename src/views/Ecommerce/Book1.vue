<template>
  ...
  <div>
    ...
    <div class="ml-4 mt-6">
        <a href="" class="font-bold text-blue-300">Birna G. Konráðsdóttir</a><br>
<p class="text-gray-500"> Hamingain I hullunum:Smasagnasafn (Icelandic Edition)</p>
<h2 class="mt-3 mb-3 font-semibold">Icelandic Edition</h2>
<img src="/book1.webp" alt="" class="w-80 ml-7">
</div>
<div class="flex ml-3 mr-3 justify-between mt-16">
    <div class="border-4 px-10 py-1 text-center">
        <a href="">
        <p>Kindle</p>
        <p class="text-xl font-semibold">$9.99</p>
        <p>Available instantly</p>
    </a>
    </div>
    <div class="border-4 px-12 pt-3 border-green-700">
        <a href="">
        <p class="font-semibold">Paperback</p>
        <p class="text-amber-700 font-bold text-xl">$33.99</p>
    </a>
    </div>
</div>
<div class="mt-5 ml-5">
    <div class="text-4xl font-semibold"><sup>$</sup>33<sup>12</sup></div>
    <div><a href="" class="mt-5 text-blue-500 font-semibold">Deliver to Ethiopia</a></div>
    <h1 class="text-green-600 font-semibold mt-3">In Stock</h1>
    <select class="bg-slate-100 w-96 py-3 px-2 rounded-md border-2 border-gray-200 mt-3">
    ...
    <button class="mt-6 bg-yellow-300 rounded-3xl text-center px-36 font-semibold  py-3">Add to Cart</button>
    <button class="mt-3 bg-orange-400 rounded-3xl text-center px-36 ml-1 font-semibold  py-3">Buy Now</button>
</div>
  </div>
  <div class="mt-10">
